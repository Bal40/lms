...
const Footer = () => {
  ...
  return (
    <footer className="bg-teal-800 text-gray-300 py-10 px-6">
      <div className="max-w-7xl mx-auto flex lg:items-center items-start justify-center gap-[40px] lg:gap-[150px] flex-col lg:flex-row">
        ...
        <div className="lg:w-[40%] md:w-[50%] w-[100%]">
          ...
          <h2 className="text-xl font-bold text-white mb-3">VidyaKumbh</h2>
          <p className="text-sm">
        ...
        <div className="lg:w-[30%] md:w-[100%]">
          ...
          <ul className="space-y-1 text-sm">
            ...
            <li className="hover:text-white cursor-pointer" onClick={() => navigate("/policies")}>Policy</li>
          </ul>
        </div>
