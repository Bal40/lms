  ...
  return (
    ...
    <div className='w-[100%] h-[70px] fixed top-0 px-[20px] py-[10px] flex items-center justify-between bg-[#00000047]  z-10'>
     <div className='lg:w-[20%] w-[40%] lg:pl-[50px] '>
        <img src={logo} className=' w-[70px]  rounded-full border-2 border-white cursor-pointer' onClick={()=>navigate("/")} alt="" />
     ...
     <div className='w-[30%] lg:flex items-center justify-center gap-4 hidden'>
        ...
        {!userData ? <IoMdPerson className='w-[50px] h-[50px] fill-white cursor-pointer border-[2px] border-[#fdfbfb] bg-green-700 rounded-full p-[10px]'onClick={()=>setShowPro(prev=>!prev)}/>:
